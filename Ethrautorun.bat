...
SET commandserver1=%minerpath% -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.dn199@eu1.ethermine.org:5555 -U --HWMON 0 -R
SET commandserver2=%minerpath% -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205@eu1.ethermine.org:5555 -U --HWMON 0 -R
SET commandserver3=%minerpath% -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205@eu1.ethermine.org:5555 -U --HWMON 0 -R
SET commandserver4=%minerpath% -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205@eu1.ethermine.org:5555 -U --HWMON 0 -R
SET commandserver5=%minerpath% -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205@eu1.ethermine.org:5555 -U --HWMON 0 -R
SET ocprogram=0
SET profile=0
SET octimeout=120
...
IF %queue% EQU 0 >> %bat% ECHO ^>^> miner.log 2^>^&1 %minerpath% -P stratum+ssl://0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205@eu1.ethermine.org:5555 -U --HWMON 0 -R
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
...
FOR /F "tokens=3 delims=|" %%N IN ('findstr.exe /I /R %criticalerrorslist% %errorslist% %warningslist% %interneterrorslist% %log%') DO (
	SET "lasterror=%%N"
...
IF %firstrun% EQU 0 (
	timeout.exe /T %cputimeout% /nobreak >NUL
	FOR /F "delims=" %%A IN ('findstr.exe /R /C:".*Initialising miner.*" %log%') DO SET /A gpucount+=1
