...
SET commandserver1=%minerpath% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr205 -zpsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0
SET commandserver2=%minerpath% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr205 -zpsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0
SET commandserver3=%minerpath% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr205 -zpsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0
SET commandserver4=%minerpath% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr205 -zpsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0
SET commandserver5=%minerpath% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr205 -zpsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0
SET ocprogram=0
SET profile=0
SET octimeout=120
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -zpool eu1-zcash.flypool.org:3333 -zwal t1S8HRoMoyhBhwXq6zY5vHwqhd9MHSiHWKv.fr205 -zpsw x -allpools 1 -tstop 80 -logfile miner.log -wd 0
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
