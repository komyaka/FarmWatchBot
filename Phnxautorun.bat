...
SET commandserver1=%minerpath% -pool eu1.ethermine.org:4444 -wal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205 -coin eth -log 1 -logfile miner.log
SET commandserver2=%minerpath% -pool eu1.ethermine.org:4444 -wal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205 -coin eth -log 1 -logfile miner.log
SET commandserver3=%minerpath% -pool eu1.ethermine.org:4444 -wal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205 -coin eth -log 1 -logfile miner.log
SET commandserver4=%minerpath% -pool eu1.ethermine.org:4444 -wal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205 -coin eth -log 1 -logfile miner.log
SET commandserver5=%minerpath% -pool eu1.ethermine.org:4444 -wal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205 -coin eth -log 1 -logfile miner.log
SET ocprogram=0
SET profile=0
SET octimeout=120
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -pool eu1.ethermine.org:4444 -wal 0xcf3cdd09dcfe2d5f9dd5e91bb25d083d5f3a6671.fr205 -coin eth -log 1 -logfile miner.log
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
...
IF %firstrun% EQU 0 (
	timeout.exe /T %cputimeout% /nobreak >NUL
	FOR /F "delims=" %%A IN ('findstr.exe /R /C:".*Starting up.*" %log%') DO SET /A gpucount+=1
