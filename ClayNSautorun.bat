...
SET commandserver1=%minerpath% -pool stratum+tcp://yiimp.eu:4233 -wal 6xGsvQ96tjm6ns5jVncQEVHePkJcg1eMJx.fr205 -psw x -tstop 80 -logfile miner.log -wd 0
SET commandserver2=%minerpath% -pool stratum+tcp://yiimp.eu:4233 -wal 6xGsvQ96tjm6ns5jVncQEVHePkJcg1eMJx.fr205 -psw x -tstop 80 -logfile miner.log -wd 0
SET commandserver3=%minerpath% -pool stratum+tcp://yiimp.eu:4233 -wal 6xGsvQ96tjm6ns5jVncQEVHePkJcg1eMJx.fr205 -psw x -tstop 80 -logfile miner.log -wd 0
SET commandserver4=%minerpath% -pool stratum+tcp://yiimp.eu:4233 -wal 6xGsvQ96tjm6ns5jVncQEVHePkJcg1eMJx.fr205 -psw x -tstop 80 -logfile miner.log -wd 0
SET commandserver5=%minerpath% -pool stratum+tcp://yiimp.eu:4233 -wal 6xGsvQ96tjm6ns5jVncQEVHePkJcg1eMJx.fr205 -psw x -tstop 80 -logfile miner.log -wd 0
SET ocprogram=0
SET profile=0
SET octimeout=120
...
IF %queue% EQU 0 >> %bat% ECHO %minerpath% -pool stratum+tcp://yiimp.eu:4233 -wal 6xGsvQ96tjm6ns5jVncQEVHePkJcg1eMJx.fr205 -psw x -tstop 80 -logfile miner.log -wd 0
>> %bat% ECHO EXIT
timeout.exe /T 3 /nobreak >NUL
START "%bat%" "%bat%" && (
...
FOR /F "delims=" %%N IN ('findstr.exe /I /R %criticalerrorslist% %errorslist% %warningslist% %interneterrorslist% %log% ^| findstr.exe /V /R /C:".*DevFee.*"') DO (
	SET "lasterror=%%N"
