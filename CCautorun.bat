...
SET interneterrorslist=/C:".*connection .*ed.*" /C:".*not resolve.*" /C:".*subscribe .*" /C:".*connect .*" /C:".*No properly.*" /C:".*tion failed.*" /C:".*Unknown algo parameter.*"
...
IF %globaltempcheck% EQU 1 SET warningslist=/C:".*temperature too high.*"
